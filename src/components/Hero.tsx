...
const Hero = () => {
  ...
  return (
    <section className="relative min-h-screen flex items-center overflow-hidden">
      ...
      <div
        className="absolute bottom-1/3 right-1/3 w-80 h-80 bg-primary/30 rounded-full blur-3xl animate-float"
      ...
      <div className="container mx-auto px-6 py-24 md:py-32">
        <div className="max-w-4xl mx-auto text-center">
          ...
          <h1
            className={`text-4xl md:text-6xl font-bold mb-6 text-foreground transition-all duration-1000 delay-300 ease-out ${
              isVisible
                ? "opacity-100 translate-y-0"
                : "opacity-0 -translate-y-8"
            }`}
          ...
          >
            ...
            type, and environmental conditions through our advanced AI
            technology.
          </p>
